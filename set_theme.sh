...
primary1=$(echo "$colours" | rg primary1 | sed "s/.*#\|;//g")
primary2=$(echo "$colours" | rg primary2 | sed "s/.*#\|;//g")
...
echo "// WARNING: generated by set_theme.sh, manual edits will not persist.
